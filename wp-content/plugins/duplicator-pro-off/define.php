...
define('DUPLICATOR_PRO_VERSION', '4.5.7');
...
$contentPath = SnapIO::safePathUntrailingslashit(WP_CONTENT_DIR, true);

if (!defined("DUPLICATOR_PRO_SSDIR_NAME")) {
    define("DUPLICATOR_PRO_SSDIR_NAME", 'backups-dup-pro');
}

if (!defined("DUPLICATOR_PRO_DEBUG_OUTPUT_INVALID")) {
    define("DUPLICATOR_PRO_DEBUG_OUTPUT_INVALID", false);
}
...
define('DUPLICATOR_PRO_BLOG_URL', 'https://snapcreek.com/blog/');
...
define('DUPLICATOR_PRO_DRAG_DROP_GUIDE_URL', DUPLICATOR_PRO_BLOG_URL . 'https://snapcreek.com/blog/how-migrate-wordpress-site-drag-drop-duplicator-pro/');
