...
$displayMultisiteTab = (false && is_multisite() && \Duplicator\Addons\ProBase\License\License::isBusiness());
...
<div data-dpro-tabs="true">
    ...
    <div>
        ...
        <div id="dup-exportdb-items-off">
            <div>
                <label><b><?php _e("Directories"); ?>:</b></label>
            ...
            <div>
                <label><b><?php _e("Extensions"); ?>:</b></label>
                <div class='dup-quick-links'>
            ...
            <?php if ($displayMultisiteTab) : ?>
                ...
                <div style="margin-top: 30px">
                    ...
                    <div class="dpro-panel-optional-txt" style="text-align: left">
                        <?php DUP_PRO_U::esc_html_e("This section allows you to control which sub-sites of a multisite network you want to include "
                            . "within your package.  The 'Included Sub-Sites' will also be available to choose from at install time."); ?> <br/>
                        <?php DUP_PRO_U::esc_html_e("By default all packages are include.  The ability to exclude sub-sites are intended to help shrink "
                    ...
                    if ($is_freelancer_plus) :
                        ...
                        <select name="installer_opts_brand" id="installer_opts_brand" onchange="DupPro.Template.BrandChange();">
                            ...
                            foreach ($brands as $i => $brand) :
                                ?>
                                <option value="<?php echo esc_attr($brand->id); ?>" title="<?php echo esc_attr($brand->notes); ?>"<?php if (isset($_REQUEST['inner_page']) && $_REQUEST['inner_page'] == 'edit') {
                                    selected($brand->id, $active_brand_id);
                                               } ?>>
