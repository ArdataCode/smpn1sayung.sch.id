        ...
        <tbody>
            ...
            foreach ($package_templates as $package_template) :
                ...
                <tr class="package-row <?php echo ($i % 2) ? 'alternate' : ''; ?>">
                    ...
                    <td class="col-name" >
                        <a href="javascript:void(0);" onclick="DupPro.Template.Edit(<?php echo intval($package_template->getId()); ?>);" class="name" data-template-id="<?php echo intval($package_template->getId()); ?>"><?php echo esc_html($package_template->name); ?></a>
                        <div class="sub-menu">
