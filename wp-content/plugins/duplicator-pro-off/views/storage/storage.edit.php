...
?>
        ...
        <tr valign="top">
            ...
            <td>
                <select id="change-mode" name="storage_type" onchange="DupPro.Storage.ChangeMode()">
                    ...
                    <?php endif; ?>
                    <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::Dropbox); ?> value="<?php echo esc_attr(DUP_PRO_Storage_Types::Dropbox); ?>"><?php esc_html_e("Dropbox", 'duplicator-pro'); ?></option>
                    <?php
                    ...
                    if ($ftp_connect_exists_filtered) {
                        ?>
                        <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::FTP); ?> value="<?php echo esc_attr(DUP_PRO_Storage_Types::FTP); ?>"><?php esc_html_e("FTP", 'duplicator-pro'); ?></option>
                        <?php
                    }
                    if (extension_loaded('gmp')) : ?>
                        <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::SFTP); ?> value="<?php echo esc_attr(DUP_PRO_Storage_Types::SFTP); ?>"><?php esc_html_e("SFTP", 'duplicator-pro'); ?></option>
                    <?php endif; ?>
                    <?php if (DUP_PRO_StorageSupported::isGDriveSupported()) :?>
                        <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::GDrive); ?> value="<?php echo esc_attr(DUP_PRO_Storage_Types::GDrive); ?>"><?php esc_html_e("Google Drive", 'duplicator-pro'); ?></option>
                    <?php endif; ?>
                    <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::Local); ?> value="<?php echo esc_attr(DUP_PRO_Storage_Types::Local); ?>"><?php esc_html_e("Local Server", 'duplicator-pro'); ?></option>
                    <?php
                    if (DUP_PRO_StorageSupported::isOneDriveSupported()) {
                        ...
                        if ($onedrive_deprecated_storage_option_disp) {
                            ...
                            ?>
                            <!--option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::OneDrive); ?> value="<?php echo DUP_PRO_Storage_Types::OneDrive; ?>"><?php esc_html_e("OneDrive v0.1", 'duplicator-pro'); ?></option-->
                            <?php
                        }
                        ?>
                        <option <?php DUP_PRO_UI::echoSelected($storage->storage_type == DUP_PRO_Storage_Types::OneDriveMSGraph); ?> value="<?php echo DUP_PRO_Storage_Types::OneDriveMSGraph; ?>"><?php esc_html_e("OneDrive", 'duplicator-pro'); ?></option>
                        <?php
                    }
                    ?>
                </select>
                <small class="dpro-store-type-notice">
                    ...
                    if (!$ftp_connect_exists_filtered) {
                        printf(esc_html__('FTP requires FTP module enabled. Please install the FTP module as described in the %s.', 'duplicator-pro'), '<a href="https://secure.php.net/manual/en/ftp.installation.php" target="_blank">https://secure.php.net/manual/en/ftp.installation.php</a>');
                        echo '<br/>';
                    }
                ...
                <td colspan="2" style="padding-left:0">
                    <i><?php echo wp_kses(
                        __("Amazon S3 Setup Guide: " .
                            ...
                            "and <a href='https://snapcreek.com/duplicator/docs/amazon-s3-policy-setup/' target='_blank'>User Bucket Policy</a>.", 'duplicator-pro'),
                        array(
                        'a' => array(
                                'href' => array(),
                                'target' => array()
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::Dropbox ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        ...
        <tr>
            <th scope="row"><label><?php esc_html_e("Hash Validation", 'duplicator-pro'); ?></label></th>
            <td>
                ...
                <label for="dropbox_skip_archive_validation_hash">Disable</label>
                 <br/>                                                    
                <p><?php esc_html_e("Turn off hash validation. This is less reliable, but may be required when transferring very large archives to avoid timeouts.", 'duplicator-pro'); ?></p>
            </td>
        </tr>
        <tr>
            ...
            <?php endif; ?>
                ...
                <?php if ($storage->onedrive_authorization_state == DUP_PRO_OneDrive_Authorization_States::Authorized) : ?>
                        ...
                        if (isset($onedrive_account_info)) {
                            ...
                            <div class="error-txt">
                                <?php
                                printf(esc_html__('Error: %s', 'duplicator-pro'), $onedrive_state_token->data->error_description);
                                // echo '<br/>';
            ...
            <td class="onedrive-authorize">
                ...
                <?php if ($storage->onedrive_authorization_state == DUP_PRO_OneDrive_Authorization_States::Authorized) : ?>
                        ...
                        if (isset($onedrive_account_info)) {
                            ...
                            <div class="error-txt">
                                <?php
                                printf(esc_html__('Error: %s', 'duplicator-pro'), $onedrive_msgraph_state_token->data->error_description);
                                echo '<br/><strong>';
                                esc_html_e('Please click on the "Cancel Authorization" button and reauthorize the OneDrive storage', 'duplicator-pro');
                                echo '</strong>';
                                ?>
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::FTP ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        ...
        <tr>
            ...
            <td>
                ...
                <label for="ftp_server"><?php esc_html_e("Port", 'duplicator-pro'); ?></label> <input name="ftp_port" id="ftp_port" data-parsley-errors-container="#ftp_server_error_container" type="text" style="width:75px"  value="<?php echo esc_attr($storage->ftp_port); ?>">
        ...
        <tr>
            ...
            <td>
                ...
                <label for="ftp_timeout_in_secs">
                        <input id="ftp_timeout" name="ftp_timeout_in_secs" data-parsley-errors-container="#ftp_timeout_error_container" type="text" value="<?php echo absint($storage->ftp_timeout_in_secs); ?>"> <label for="ftp_timeout_in_secs"><?php esc_html_e("seconds", 'duplicator-pro'); ?></label>
                        <br>
        ...
        <table id="provider-<?php echo DUP_PRO_Storage_Types::SFTP ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
            ...
            <tr>
                ...
                <td>
                    ...
                    <label for="sftp_server"><?php esc_html_e("Port", 'duplicator-pro'); ?></label> <input name="sftp_port" id="sftp_port" data-parsley-errors-container="#sftp_server_error_container" type="text" style="width:75px"  value="<?php echo esc_attr($storage->sftp_port); ?>">
            ...
            <tr>
                ...
                <td>
                    <label for="sftp_timeout_in_secs">
                        <input id="sftp_timeout" name="sftp_timeout_in_secs" data-parsley-errors-container="#sftp_timeout_error_container" type="text" value="<?php echo absint($storage->sftp_timeout_in_secs); ?>"> <label for="sftp_timeout_in_secs"><?php esc_html_e("seconds", 'duplicator-pro'); ?></label>
                        <br>
                        <i><?php esc_html_e("Do not modify this setting unless you know the expected result or have talked to support.", 'duplicator-pro'); ?></i>
                    </label>
            ...
            <?php if ($storage->gdrive_authorization_state == DUP_PRO_GDrive_Authorization_States::Unauthorized) : ?>
                    <div class='gdrive-authorization-state' id="gdrive-state-unauthorized">
                        ...
                        <div id="dpro-gdrive-steps">
                            ...
                            <button id="gdrive-finalize-setup" type="button" class="button" onclick="DupPro.Storage.GDrive.FinalizeSetup(); return false;"><i class="fa fa-check-square"></i> <?php esc_html_e('Finalize Setup', 'duplicator-pro'); ?></button>
                        </div>
                    </div>
            <?php else : ?>
            ...
            <td>
                ...
                <p>
                    ...
                    <i class="fas fa-question-circle fa-sm"
                       ...
                       data-tooltip="<?php esc_attr_e('If the directory path above is already in Google Drive before connecting then a duplicate folder name will be made in the same path. This is because the plugin only has rights to folders it creates.', 'duplicator-pro'); ?>">
                    </i>
