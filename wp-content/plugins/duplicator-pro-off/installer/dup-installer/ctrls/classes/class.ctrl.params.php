...
final class DUPX_Ctrl_Params
{
    ...
    public static function setParamsStep1()
    {
        ...
        if (self::$paramsValidated) {
            ...
            $paramsManager->setValue(PrmMng::PARAM_MU_REPLACE, $archive_config->getNewUrlsArrayIdVal());
    ...
    protected static function updateBlogname($oldSubsiteId)
    {
        ...
        $paramsManager->setValue(PrmMng::PARAM_BLOGNAME, $archive_config->getBlognameFromSelectedSubsiteId());
    }
