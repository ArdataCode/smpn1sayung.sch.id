...
.dupx-branding-header img {max-width:100%;}
...
div.overview-description h2 {margin:0; font-size:17px}
div.overview-description p {margin:2px}
h2.overview-install-type{text-transform: capitalize;}
div.overview-subtxt-1 {font-style:italic}
div.overview-subtxt-2 {font-weight:bold; font-size:11px; margin-top:15px; text-align:center}
...
.s1-validate-flagged-tbl-list {max-height:500px; border:1px solid #d3d3d3; overflow-y:scroll; background:#efefef;}
.s1-validate-sub-status td:first-child {font-weight:bold}
.s1-validate-sub-status td {padding:1px 5px 1px 5px}
.s1-validate-sub-status td small {font-weight:normal}

.s1-checks-area {width:100%; margin:0; padding:0}
.s1-checks-area td.title {font-size:16px; width:100%}
.s1-checks-area td.title small {font-size:11px; font-weight:normal}
.s1-checks-area td.toggle {font-size:11px; margin-right:7px; font-weight:normal}
